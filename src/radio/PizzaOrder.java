...
public class PizzaOrder extends JFrame implements ItemListener, ActionListener {
	...
	public PizzaOrder() {
		...
		// 테두리 설정
		Border border1 = BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.DARK_GRAY), "종류",
				TitledBorder.LEFT, TitledBorder.TOP, new Font("나눔 고딕", Font.BOLD, 13));
		panel_2.setBorder(border1);

		border1 = BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.DARK_GRAY), "추가 토핑",
				TitledBorder.LEFT, TitledBorder.TOP, new Font("나눔 고딕", Font.BOLD, 13));
		panel_3.setBorder(border1);

		border1 = BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.DARK_GRAY), "크기",
				TitledBorder.LEFT, TitledBorder.TOP, new Font("나눔 고딕", Font.BOLD, 13));
